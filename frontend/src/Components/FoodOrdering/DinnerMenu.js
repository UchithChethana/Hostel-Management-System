...
const DinnerMenu = () => {
  return (
    ...
    >
      <div className="max-w-5xl mx-auto bg-slate-950 bg-opacity-90 mt-20 mb-20 rounded-lg  shadow-md p-6">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-4xl text-white  ml-96 font-bold">Dinner Menu</h1>
        </div>
