...
//   const handleEdit = (productId) => {
//     navigate(`${productId}`); // Navigate to EditProduct with product ID
//   };
...
//     navigate(`/view-product/${productId}`); // Implement view functionality as needed
//   };
...
//                     <img src={product.imageUrl || 'default_image_url'} alt={product.name} className="h-10 w-10 object-cover" />
//                   </td>
...
//                       <FontAwesomeIcon icon={faTrashAlt} />
//                     </button> */}
//                     <button className="text-gray-500" onClick={() => handleView(product._id)}>
//                       <FontAwesomeIcon icon={faEye} />
//                     </button>
//                   </td>
//                 </tr>
